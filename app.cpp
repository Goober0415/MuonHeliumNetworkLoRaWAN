...
const uint8_t devEui[8] = {0x17, 0x50, 0x32, 0x34, 0x82, 0x39, 0x3A, 0x20};
...
void setup()
{
    ...
    uint8_t appKey[16] = {0x22, 0x06, 0xDB, 0x6B, 0x35, 0xC1, 0x5B, 0xB4,
                          0x51, 0x11, 0x2D, 0x91, 0x70, 0x71, 0xAC, 0xC9};
